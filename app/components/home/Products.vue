...
<template>
  ...
  >
    <div class="z-[3] flex h-screen max-h-screen flex-col justify-center px-6 lg:px-0">
      <div class="flex w-full justify-center">
        <h4 class="mb-8 text-3xl text-[#e3d268] md:mb-16 lg:text-4xl">Productos</h4>
      </div>

      <ul ref="listRef" class="grid grid-cols-2 gap-6 lg:grid-cols-3 lg:px-16 lg:pt-[7.5rem]">
        <button
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <h4 class="text-2xl font-bold text-[#003B49]">{{ category.nombre }}</h4>
              </div>
